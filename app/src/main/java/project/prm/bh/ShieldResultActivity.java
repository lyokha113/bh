...
public class ShieldResultActivity extends AppCompatActivity {

    private ActionBar actionBar;
    private MaterialButton saveShield;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_shield_result);

        actionBar = getSupportActionBar();
        saveShield = findViewById(R.id.saveShield);
        saveShield.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showAlertDialog("LƯU THẺ", "Lưu vào tài khoản thành công.", "ĐÓNG");
                saveShield.setVisibility(View.GONE);
            }
        });
        setupActionBar();
    }
